...
class SprCpu final : public EaglestreamCpu, public CpuGeneric
{
    ...
    [[nodiscard]] std::optional<TORDataGeneric> parseTorData(const json& index)
    {
        ...
        else if (Id == "0x806f1")
        {
            ...
            tor.tordump1_subindex6_spr2 = tor.tordump1_subindex6_spr1;
        }
        else
        {
            ...
            tor.tordump1_subindex6_spr3 = tor.tordump1_subindex6_spr1;
            tor.tordump1_subindex7_spr3 = tor.tordump1_subindex7_spr1;
        }
        return tor;
    }
